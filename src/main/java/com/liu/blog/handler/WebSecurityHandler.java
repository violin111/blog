...
import com.liu.blog.annotation.AccessLimit;
...
import static com.liu.blog.constant.CommonConst.APPLICATION_JSON;
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object handler) throws Exception {
        ...
        if (handler instanceof HandlerMethod) {
            ...
            if (accessLimit != null) {
                ...
                String key = IpUtils.getIdAddress(httpServletRequest)+hm.getMethod().getName();
                        //IpUtils.getIpAddress(httpServletRequest) + hm.getMethod().getName();
                // 从redis中获取用户访问的次数
                try {
